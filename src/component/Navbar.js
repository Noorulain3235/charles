  ...
  return (
    <header className={`top-5 left-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white shadow-lg px-10' : 'bg-white px-5'}`}>
      <div className="flex items-center justify-between py-4 max-w-7xl mx-auto">
        ...
        <img src="/images/images__3_-removebg-preview.png" alt="" className="w-[90px] h-[100px]" />
      ...
      <div className="flex items-start gap-3">
        <img src="/images/images__3_-removebg-preview.png" alt="Location" className="w-[90px] h-[100px]" />
        <div className="mt-6">
      ...
      {/* Mail Block */}
      <div className="flex items-start gap-3">
        <img src="/images/images (2).png" alt="Mail" className="w-[50px] h-[60px]" />
        <div className="mt-1">
